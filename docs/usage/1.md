...
quay.io/ocpmigrate/mig-ui:htb2
...
A manifest for deploying mig-operator to OpenShift 3.x and 4.x has been made available as [operator.yml](https://raw.githubusercontent.com/fusor/mig-operator/htb2/operator.yml)


```
# The operator manifest should be downloaded and edited to the specifications above.
# https://raw.githubusercontent.com/fusor/mig-operator/htb2/operator.yml
...
The sample [`controller-3.yml`](https://raw.githubusercontent.com/fusor/mig-operator/htb2/controller-3.yml) and [`controller-4.yml`](https://raw.githubusercontent.com/fusor/mig-operator/htb2/controller-4.yml) are provided with recommended defaults for:
...
https://raw.githubusercontent.com/fusor/mig-operator/htb2/controller-3.yml


### OpenShift 4.x
For each OpenShift 4.x cluster that will be involved in the migration, use  controller-4.yml as a starting point

https://raw.githubusercontent.com/fusor/mig-operator/htb2/controller-4.yml

...
### Monitoring the work of mig-operator
...
1. To visit the UI, look at the route on the cluster where you specified mig-ui should be installed in the MigrationController CR.
```bash
